#ifndef ROOT_Gmp_Xscin
#define ROOT_Gmp_Xscin
...
protected:
  ...
  Double_t*   fLPeak;      // [fNelem] TDC peaks for left paddles
  Double_t*   fRPeak;      // [fNelem] TDC peaks for right paddles
  ...
  ClassDef(Gmp_Xscin,1)   // Generic scintillator class
};
